          ...
          <div className="flex items-center gap-3">
            {submission?.pdf_url ? (
              <div className="flex items-center gap-2">
                <Link
                  href={`/${locale}/admin/proposals/new?formId=${form.id}`}
                  className="bg-[#141414] text-[#F5F5F0] border border-[#222] px-6 py-4 rounded-full font-medium tracking-[0.08em] uppercase text-sm hover:border-[#444] transition-colors flex items-center gap-3">
                  <ExternalLink size={18} /> Crear Proposal
                </Link>
                <a
